...
CREATE TABLE public.forms (
  ...
  header_color text,
  layout_mode USER-DEFINED NOT NULL DEFAULT 'single_question_per_page'::form_layout_mode,
...
CREATE TABLE public.questions (
  ...
  CONSTRAINT questions_page_id_fkey FOREIGN KEY (page_id) REFERENCES public.form_pages(id)
);
...
CREATE TABLE public.form_access_tokens (
  form_id uuid NOT NULL,
  token_code text NOT NULL,
  updated_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT form_access_tokens_pkey PRIMARY KEY (form_id),
  CONSTRAINT form_access_tokens_form_id_fkey FOREIGN KEY (form_id) REFERENCES public.forms(id)
);
CREATE TABLE public.form_pages (
  ...
  CONSTRAINT form_pages_form_id_fkey FOREIGN KEY (form_id) REFERENCES public.forms(id)
);