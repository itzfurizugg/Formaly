    ...
    return (
        <div className={`relative ${className}`}>
            <input
                ...
                {...rest}
                className={`input w-full bg-second border-darks/10 dark:bg-second lg:dark:bg-base dark:border-darks/10 focus:border-done focus:outline-none transition-colors font-sans text-sm pr-11 placeholder:[-webkit-text-fill-color:color-mix(in_oklab,var(--color-base-content)_50%,transparent)] ${
                    visible
                        ? "text-darks"
