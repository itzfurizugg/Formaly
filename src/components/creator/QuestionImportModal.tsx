...
export default function QuestionImportModal({ formId, startingOrder, fallbackPageId, oneQuestionPerPage = false, onClose, onImported }: QuestionImportModalProps) {
    ...
    return (
        ...
        >
            <motion.div variants={modalPanel} className="w-full max-w-2xl max-h-[90vh] overflow-hidden bg-white dark:bg-second border border-second shadow-xl rounded-xl flex flex-col">
